...
class ProductImageSeeder extends Seeder
{
    public function run()
    {
        ...
        foreach ($products as $product) {
            ...
            if ($product->id == 15) { // sony a1 camera
                $imageUrls = [
                    'https://static.bhphoto.com/images/images500x500/1732015006_1861705.jpg',
                ];
            }

            if ($product->id == 16) { // Canon EOS R6 Mark II Mirrorless Camera
                $imageUrls = [
            ...
            if ($product->id == 17) { // Sony FE 70-200mm f/4 Macro G OSS II Lens
                $imageUrls = [
            ...
            if ($product->id == 18) { // Canon RF 24-70mm f/2.8 L IS USM Lens
                $imageUrls = [
            ...
            if ($product->id == 23) { // SONY a7R V Mirrorless Camera
                $imageUrls = [
